...
[ ] - Contexto do DDD ficou compartilhado para as três api’s. Cada Api deve ter o seuApplication, Dominio e Data separados.
[ ] - RepositoryBase se encontra no csproj Data, entendo que ele deveria estar noShared pois será a lib compartilhada para as 3 api’s
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ------------------------------------- |
| ** Program - Criar Extension para configuração do AutoMapper **                                                                                                                           | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** Program - Criar Extension para configuração dos Service/Repository **                                                                                                                  | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestController - \_logger nao está sendo utilizado. **                                                                                                                           | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestController Criar abstração no seu controller base para retorno de NoContent() dos métodos Get **                                                                             | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestController - Criar abstração no seu controller base para retorno de NoContent() dos métodos Get **                                                                           | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** ApplicationBuyRequestService - GetAll - Paginação está sendo feita da camada de Application, deveria ser feito na camada de Repository. **                                             | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
...
| Fazer paginação antes do primeiro ToList. \*\*                                                                                                                                            | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
...
| Pesquisar forma correta de realizar um count sem trazer todo o objeto para a memoria. \*\*                                                                                                | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
...
| ** BuyRequestRepository - Add - dbSet.AddAsync está sem await **                                                                                                                          | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestRepository - Add - Criar abstração para comunicação com api de CashBook nao é obrigação do repository fazer esse envio. **                                                   | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** Utilizar AutoMapper para converter BuyRequest para CashBookDto **                                                                                                                      | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** Utilizar AutoMapper para converter BuyRequest para CashBookDto **                                                                                                                      | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
...
| ** BuyRequestService - Update - Caso nao seja uma Entidade Valida nem precisarealizar a consulta do GetById, adicionar validação antes. **                                                | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestRepository - GetById - Está sendo realizado uma consulta por Client ou Id, criar metodo separado para busca por Client, busca por Client nao condiz com o nome do método. ** | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestRepository - Update - Utilizar abstração para comunicação com API de CashBook. **                                                                                            | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
...
| Utilizar abstração para comunicação com API de CashBook.\*\*                                                                                                                              | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestRepository - Remove - Não está sendo validado se existe pelo Id, caso passe um Id inexistente dará erro. E o delete quando passa um Id inexistente deve retornar true. **    | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
| ** BuyRequestRepository - Remove - Metodo está retornar um, BuyRequest mas esse objeto acabou de ser deletado, alterar para boolean. **                                                   | <input type="checkbox" checked/> TODO | <input type="checkbox" /> DONE        |
